      ...
      <section id="teamsSousComp">
        <article>
          <section id="teams-section">
            <h3>Teams</h3>
            <AllTeamsContainer></AllTeamsContainer>
          </section>
        ...
        <article>
          {teamInfo || props.location.state ?
            <section>
              <h2>{teamInfo ? teamInfo.teamname : props.location.state.team.teamname}</h2>
...
</svg>{teamInfo ? (teamInfo.locked ? "Unlock" : "Lock" ): null} {props.location.state ? (props.location.state.team.locked ? "Unlock" : "Locked"): null} </button>
              : null}
              <TeamComposition teamProps={props.location.state ? props.location.state.team : null}></TeamComposition>
            </section>
            :
            <section>
              <p id="chooseTeam">Select a team</p>
            </section>
        }
        </article>
